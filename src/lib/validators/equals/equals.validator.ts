 ...
 * @param prefix The prefix that should be used for the property name when an object is returned representing the invalid control state. 
 *               (Defaults to 'equals-')
 * @returns ValidatorFn
 */
export function equals(form: () => FormGroup, controlName: string, prefix = 'equals-'): ValidatorFn {
